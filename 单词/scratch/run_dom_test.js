...
Object.defineProperty(Element.prototype, 'innerHTML', {
  ...
  set: function(val) {
    this._innerHTML = val;
    // If it contains class="half", simulate children
    this.children = [];
...
print('Render executed successfully! Rendered sections/rows in listEl:', listEl.children.length);

toggleEdit();
print('Edit mode rendered successfully! ListEl children count:', listEl.children.length);
toggleEdit();
print('Switched back to reading mode successfully! ListEl children count:', listEl.children.length);
